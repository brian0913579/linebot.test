...
if USE_GOOGLE_SECRET_MANAGER:
    try:
        ...
        if not GCP_PROJECT_ID:
            logger.warning("Google Cloud Secret Manager enabled but GOOGLE_CLOUD_PROJECT not set")
    except ImportError:
        logger.error("Google Cloud Secret Manager requested but google-cloud-secret-manager not installed")
